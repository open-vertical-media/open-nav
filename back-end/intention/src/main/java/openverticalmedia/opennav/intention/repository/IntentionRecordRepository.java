...
@Repository
public interface IntentionRecordRepository extends JpaRepository<IntentionRecordEntity,Long> {
    ...
    Page<IntentionRecordEntity> query(Long partnerId,String name,String telephone,Pageable pageable);

    Page<IntentionRecordEntity> findByPartnerId(long partnerId,Pageable pageable);
}
